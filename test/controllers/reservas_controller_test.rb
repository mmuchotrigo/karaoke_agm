...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { description: @reserva.description, local_id: @reserva.local_id, reserved_at: @reserva.reserved_at, sala_id: @reserva.sala_id }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { description: @reserva.description, local_id: @reserva.local_id, reserved_at: @reserva.reserved_at, sala_id: @reserva.sala_id }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
